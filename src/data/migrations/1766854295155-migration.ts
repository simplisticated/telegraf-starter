...
export class Migration1766854295155 implements MigrationInterface {
    name = 'Migration1766854295155'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Bot" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "created" datetime NOT NULL DEFAULT (datetime('now')), "updated" datetime DEFAULT (datetime('now')), "telegram_id" text NOT NULL, "username" text NOT NULL, "can_join_groups" boolean NOT NULL, "can_read_all_group_messages" boolean NOT NULL, "supports_inline_queries" boolean NOT NULL, CONSTRAINT "UQ_894dfeb8bb3555d7c6cf4fcf124" UNIQUE ("telegram_id"))`);
