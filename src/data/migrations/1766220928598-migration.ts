...
export class Migration1766220928598 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "temporary_User"("id", "creation_date", "modification_date", "is_administrator", "is_blocked", "state", "bot_id", "telegram_profile_id") SELECT "id", "creation_date", "modification_date", "is_administrator", "is_blocked", "state", "bot_id", "telegram_profile_id" FROM "User"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "User" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "creation_date" datetime NOT NULL DEFAULT (datetime('now')), "modification_date" datetime DEFAULT (datetime('now')), "is_administrator" boolean NOT NULL DEFAULT (0), "is_blocked" boolean NOT NULL DEFAULT (0), "state" json NOT NULL, "bot_id" integer NOT NULL, "telegram_profile_id" integer NOT NULL)`);
        await queryRunner.query(`INSERT INTO "User"("id", "creation_date", "modification_date", "is_administrator", "is_blocked", "state", "bot_id", "telegram_profile_id") SELECT "id", "creation_date", "modification_date", "is_administrator", "is_blocked", "state", "bot_id", "telegram_profile_id" FROM "temporary_User"`);
